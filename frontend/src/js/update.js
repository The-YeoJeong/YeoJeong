...
import update from '../html/update.html';
import map from './map';
...
console.log(postInfoTest.postTitle)
  node.querySelector('#post-title').value = postInfoTest.postTitle;
  node.querySelector('#plan-period-startdate').value = postInfoTest.postStartDate.substr(0, 10);
  node.querySelector('#plan-period-enddate').value = postInfoTest.postEndDate.substr(0, 10);
